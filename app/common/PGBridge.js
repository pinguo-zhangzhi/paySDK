...
(function(){
	...
	window.PG.Promise = function(func){
	...
	var fn = window.PG.Promise.prototype;
...
(function(window) {
	...
	var getJSON = function() {
		...
		var host = 'activity-test.camera360.com';

		switch(window.PG.config.mode) {
			case 'dev':
					host = 'activity-test.camera360.com';
				break;
			case 'qa':
					host = 'activity-qa.camera360.com';
				break;
			case 'online':
					host = 'activity.camera360.com';
				break;
		}
	...
	a.uploadWeixinImage = function(data){
		return new Promise(function(callback){
			getJSON('Photo/UploadWeixinImage', data, callback?callback:function(){});
		});
	}

	a.uploadNativeImage = function(data){
		return new Promise(function(callback){
			getJSON('Photo/UploadNativeImage', data, callback?callback:function(){});
		});
	}

	a.cutImage = function(data){
		return new Promise(function(callback){
			getJSON('Photo/CutImage', data, callback?callback:function(){});
		});
	}

	window.PG.server = Server;
